...
raytrace : 
	...
	@+cd ./raytrace && $(MAKE) -f raytrace_linux32.mak $(CLEANPARAM)
...
TAGS:
	...
	@find ./raytrace -name '*.cpp' -print0 | xargs -0 etags --declarations --ignore-indentation --append
	@find ./raytrace -name '*.h' -print0 | xargs -0 etags --language=c++ --declarations --ignore-indentation --append
	@find ./raytrace -name '*.c' -print0 | xargs -0 etags --declarations --ignore-indentation --append
