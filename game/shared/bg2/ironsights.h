...
#define IRONSIGHTS_ATTACK_DELAY_IN_FAST	0.1f	//delay of primary/secondary attacks after pressing zoom
#define IRONSIGHTS_ATTACK_DELAY_IN_SLOW	0.6f	//delay of primary/secondary attacks after pressing zoom
