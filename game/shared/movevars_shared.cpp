...
ConVar	sv_maxvelocity("sv_maxvelocity", "14400", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis.");
//
