...
#define MAX_WEAPON_POSITIONS	4	// max number of items within a slot
#define MAX_ITEM_TYPES			6	// hud item selection slots
#define MAX_WEAPONS				4	//BG3 - changed from 48 to 3, for efficiency's sake  // Max number of weapons available
...
#define TEAM_UNASSIGNED			0	// not assigned to a team, used by flags
...
#define COLOR_ORANGE	Color(255, 128, 20, 255)
...
#define COLOR_OFF_WHITE		Color(232, 233, 187, 255)
