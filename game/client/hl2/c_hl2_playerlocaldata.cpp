...
BEGIN_RECV_TABLE_NOBASE( C_HL2PlayerLocalData, DT_HL2Local )
	//RecvPropFloat( RECVINFO(m_flSuitPower) ), BG2 - everything commented out here and later in the .cpp we don't want in BG2 - found this while porting to 2016 engine - Awesome
