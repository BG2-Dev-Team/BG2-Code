...
const char *g_ppszRandomCitizenModels[] = 
{
	...
	"models/player/british/light_b/light_balt.mdl",
	"models/player/british/light_b/light_balt2.mdl",
};
...
const char *g_ppszRandomCombineModels[] =
{
	...
	"models/player/american/light_a/light_aalt.mdl",
	"models/player/american/light_a/light_aalt2.mdl",
};
...
void CHL2MP_Player::GiveDefaultItems( void )
{
	...
	if( GetTeam()->GetTeamNumber() == TEAM_AMERICANS )	//Americans
	{
		...
		case CLASS_OFFICER:
			if (m_iClassSkin == 1)
			{
				GiveNamedItem( "weapon_pistol_a_alt" );
				GiveNamedItem( "weapon_sabre_a_alt" );
			}
			else if (m_iClassSkin == 2)
			{
				GiveNamedItem( "weapon_pistol_a_alt2" );
				GiveNamedItem( "weapon_sabre_a_alt2" );
			}
			else
			{
				GiveNamedItem( "weapon_pistol_a" );
	...
	else if( GetTeam()->GetTeamNumber() == TEAM_BRITISH )	//british
	{
		...
		case CLASS_OFFICER:
			if (m_iClassSkin == 1)
			{
				GiveNamedItem( "weapon_pistol_b_alt" );
				GiveNamedItem( "weapon_sabre_b_alt" );
			}
			else if (m_iClassSkin == 2)
			{
				GiveNamedItem( "weapon_pistol_b_alt2" );
				GiveNamedItem( "weapon_sabre_b_alt2" );
			}
			else
			{
				GiveNamedItem( "weapon_pistol_b" );
...
void CHL2MP_Player::PlayermodelTeamClass( int team, int classid, int skinid )
{
	...
	case TEAM_AMERICANS:
		...
		case CLASS_OFFICER:
			if (skinid == 1)
				SetModel("models/player/american/light_a/light_aalt.mdl");
			else if (skinid == 2)
				SetModel("models/player/american/light_a/light_aalt2.mdl");
			else
	...
	case TEAM_BRITISH:
		...
		case CLASS_OFFICER:
			if (skinid == 1)
				SetModel("models/player/british/light_b/light_balt.mdl");
			else if (skinid == 2)
				SetModel("models/player/british/light_b/light_balt2.mdl");
			else
