...
#ifndef USE_ENTITY_BULLET
	// BG2 - (VisualMelon) - the bullets have their own physics system. run it now
	UpdateBullets();
#endif
...
static ConVar motdfile( "motdfile", "motd.htm", 0, "The MOTD file to load.", ValidateMOTDFilename );
